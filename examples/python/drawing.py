...
COLORS_DICT = {
    ...
    'handl': [
        [255,  0,  0],[191, 47, 47],[127, 63, 63],[ 63, 47, 47],[255, 76,  0],
        [191, 57,  0],[127, 38,  0],[ 63, 19,  0],[255,152,  0],[191,114,  0],
        [127, 76,  0],[ 63, 38,  0],[255,255,  0],[191,191,  0],[127,127,  0],
        [ 63, 63,  0],[  0,255,  0],[  0,191,  0],[  0,127,  0],[  0, 63,  0]
    ],
    'handr': [
        [255,  0,153],[191,  0,114],[127,  0, 76],[ 63,  0, 38],[203,  0,255],
        [152,  0,191],[101,  0,127],[ 50,  0, 63],[ 50,  0,255],[ 37,  0,191],
        [ 25,  0,127],[ 12,  0, 63],[  0,102,255],[  0, 76,191],[  0, 51,127],
        [  0, 25, 63],[  0,255,255],[  0,191,191],[  0,127,127],[  0, 63, 63]
    ],
    'face': [[255,255,255]] * 70
}
